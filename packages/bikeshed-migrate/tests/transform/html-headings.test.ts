...
describe('html-headings transform', () => {
    it('converts <h2 id="x"> to markdown heading (demoted one level)', async () => {
...
`;
    ...
    it('converts <h3 id="x"> to depth-4 heading (demoted one level)', async () => {
...
`;
    ...
    it('converts heading without id (no id suffix, demoted one level)', async () => {
